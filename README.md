...
Final Year Project (using PHP, HTML, CSS, MySQL, XML, JSON, CSV): <br/>
<ul><li>(source code): https://github.com/jillchiu/myweb/tree/main/Final%20Year%20Project </li></ul>
Shopping cart (1) (using PHP, HTML, CSS, JavaScript): <br/>
...
Shopping cart (2) (using React, HTML, CSS, JavaScript): <br/>
