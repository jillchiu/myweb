...
/* fullpage and animate.css control */
$(function () {
	$('#fullpage').fullpage({
		navigation: true,
		...
		afterLoad: function(origin, destination){
			...
			if(origin.index == 0){
				$(".welcome").css('animation-delay', '.8s').addClass("animated zoomInDown");
				$(".tips").css('animation-delay', '1s').addClass("animated bounceInUp");
			}
		...
		onLeave: function(origin, destination){
			...
			$in_section = $(".section").eq(destination.index);
			$out_section = $(".section").eq(origin.index);
			
			$(".welcome", $in_section).css('animation-delay', '.8s').addClass("animated zoomInDown");
			$(".tips", $in_section).css('animation-delay', '1s').addClass("animated bounceInUp");
			$(".appeal_left", $in_section).css('animation-delay', '.4s').addClass("animated fadeInLeftBig");
			$(".appeal_right", $in_section).css('animation-delay', '.4s').addClass("animated fadeInRightBig");
			$(".appeal_up", $in_section).css('animation-delay', '.4s').addClass("animated bounceInUp");
			$(".appeal_down", $in_section).css('animation-delay', '.4s').addClass("animated rotateInDownLeft");
			$(".appeal_link", $in_section).css('animation-delay', '.4s').addClass("animated flip");
			
			$(".welcome", $out_section).removeClass("animated zoomInDown");
			$(".tips", $out_section).removeClass("animated bounceInUp");
			$(".appeal_left", $out_section).removeClass("animated fadeInLeftBig");
			$(".appeal_right", $out_section).removeClass("animated fadeInRightBig");
			$(".appeal_up", $out_section).removeClass("animated bounceInUp");
			$(".appeal_down", $out_section).removeClass("animated rotateInDownLeft");
			$(".appeal_link", $out_section).removeClass("animated flip");
		}
	});
});
...
//fullpage & animate control
$(function () {
	$('#fullpage_portfolio').fullpage({
		navigation: true,
		navigationPosition: "right",
		navigationTooltips: ["page1", "page2", "page3", "page4"],
		showActiveTooltip: true,
		sectionsColor : ['white', 'black', '#ccc', 'white'],
		afterLoad: function(origin, destination){
			
			if(origin.index == 0){
				$(".welcome_portfolio").css('animation-delay', '.8s').addClass("animated bounceIn");
			}
		...
		onLeave: function(origin, destination){
			...
			$(".welcome_portfolio", $in_section).css('animation-delay', '.8s').addClass("animated bounceIn");
			$(".end_portfolio", $in_section).css('animation-delay', '1s').addClass("animated fadeInUp");
			
			$(".welcome_portfolio", $out_section).removeClass("animated bounceIn");
			$(".end_portfolio", $out_section).removeClass("animated fadeInUp");
		}
	});
});