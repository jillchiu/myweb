		...
		?>
			...
			<b>Please select and fill in all columns:</b><br/><br/>
				...
				?>
					...
					<tr><td><FONT COLOR='BEFF54'>Select the room type: </FONT></td>
					<td>
						<select name='room'>
					...
					*/
					...
					<FONT COLOR="FFFFFF">**Select the room type and system will automatically to assign the room for you if it is vacancy at the date you wanted.</FONT>
					
					<tr><td><FONT COLOR='BEFF54'>Date for check in : </FONT></td><td><input type="date" name="date" min="<?=date('Y-m-d') ?>" value="<?=date('Y-m-d') ?>" max="<?=date('Y-m-d', strtotime("+30 day", time())) ?>" value="<?=date('Y-m-d')?>" required="required" /></td></tr>
					...
					<tr><td><FONT COLOR='BEFF54'>Extra services : </FONT></td></tr>
					...
					<?php
						...
						while ($row9 = $result9->fetch_object()){
							...
							echo "<tr><td></td><td><input type='checkbox' name='extra".$row9->eid."' value=".$row9->eid."><FONT COLOR='BEFF54'>".$row9->service_name."</FONT></td></tr>";
					...
					<tr><td><FONT COLOR='BEFF54'>Number of people : </FONT></td><td><input type="number" name="number" min="1" max="5" required="required" /></td></tr>
