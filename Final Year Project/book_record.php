...
<?php
	...
	$result2 = $mysqli->query("select * from book where uid='$uid' order by check_in_date");
			...
			<b>Booking records:</b><br/><br/>
				...
				<?php
					...
					while($row2 = $result2->fetch_object()){
						...
						echo "<td><a href=booking_update.php?bid=".$row2->bid." ><FONT COLOR='FFFFFF'>Edit</FONT></a></td>";
						echo "<td><a href=booking_delete.php?bid=".$row2->bid." ><FONT COLOR='FFFFFF'>Delete</FONT></a></td></tr>";
					}
				...
				<h2>Total price (non pay bookings only) : $<?php echo $t_price ?></h2><br/><br/>
				
				Click <a href="book.php"><FONT COLOR="FFFFFF">here</FONT></a> to back to front page.
		</div>
