		...
		?>
			...
			<?php
				...
				if(!$row3 = mysqli_fetch_array($result3)){
						...
						echo "<FONT COLOR='BEFF54'>You can click <a href='booking_day.php' /><FONT COLOR='FFFFFF'>here</FONT></a> to view the booking record.</FONT>";
						...
						$result6 = $mysqli->query("select uid from book where bid='$bid'");
						
						$row5 = $result6->fetch_object();
						...
						if(($checkid)==($checkid2)){
							...
							echo "<FONT COLOR='BEFF54'>You can click <a href=booking_update2.php?bid=".$bid." ><FONT COLOR='FFFFFF'>here</FONT></a> to back to front page.</FONT>";
