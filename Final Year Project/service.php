	...
	<div id="container">
		...
		?>
			...
			<ul> 
				...
				<li>
					<a href="room.php"><FONT COLOR="BEFF54">View the room type and its information</FONT></a>
				</li>
				<li>
					<a href="extra.php"><FONT COLOR="BEFF54">View the activities and extra service</FONT></a>
				</li>
